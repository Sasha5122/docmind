...
2026-09-01T14:26:58+00:00 · 96 questions · LLM `none:retrieval-only` · retrieval `hybrid` k=5 · reranker `CrossEncoderReranker` · judge `None`
...
| abstention rate | 0 % |
| latency p50 / p95 | 0.785 s / 2.447 s |
| of which retrieval / rerank / LLM (mean) | 0.432 / 0.745 / 0.0 s |
