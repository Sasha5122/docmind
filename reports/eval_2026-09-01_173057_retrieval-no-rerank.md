# Eval: retrieval-no-rerank

2026-09-01T14:30:57+00:00 · 96 questions · LLM `none:retrieval-only` · retrieval `hybrid` k=5 · reranker `NoopReranker` · judge `None`
...
| recall@10 | 92 % |
| MRR | 0.65 |
| context hit@k (correct page among the k chunks given to the LLM, after reranking) | 82 % |
| context MRR | 0.63 |
| citation precision | – |
...
| abstention rate | 0 % |
| latency p50 / p95 | 0.129 s / 0.177 s |
| of which retrieval / rerank / LLM (mean) | 0.31 / 0.0 / 0.0 s |
